...
const top_1 = [
  "EPL Clubs to go on strike",
  "Mars, our next frontier",
  "Microsoft to invest $200M in startups",
  "Dance 254 is back and popping!",
];

const top_2 = [
  "Tech startups on the rise!",
  "Gun-plant to theaten security",
  "Covid-19 vaccines production in Kenya",
  "President re-opens the country",
];

const author = [
  { src: <GitHubIcon />, url: "https://github.com/mowandugu" },
  { src: <LinkedInIcon />, url: "https://www.linkedin.com/in/MarkWandugu/" },
  { src: <InstagramIcon />, url: "https://www.instagram.com/markbrozz/" },
  { src: <TwitterIcon />, url: "https://twitter.com/markbrozz" },
];
